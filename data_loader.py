...
def load_all_datasets():
    ...
    Uses 'latin-1' encoding to handle special characters and accents safely.
    """
    ...
    # Fixed: Added encoding="latin-1" to capture special characters
    df_cities = pd.read_csv(cities_file, encoding="latin-1")
    ...
    df_planner = pd.read_csv(planner_file, encoding="latin-1")
    ...
    df_rec = pd.read_csv(rec_file, encoding="latin-1")
    ...
    df_agency = pd.read_csv(agency_file, encoding="latin-1")
...
if __name__ == "__main__":
    ...
    print("All datasets loaded successfully without encoding errors!")
